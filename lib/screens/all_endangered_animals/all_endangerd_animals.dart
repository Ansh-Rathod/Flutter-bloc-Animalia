import 'package:animalapp/screens/all_breed_animals/stream.dart';
import 'package:animalapp/screens/all_endangered_animals/stream.dart';
...
class AllEndangeredAnimalsByBreed extends StatelessWidget {
  final String name;
  final String image;
  final int index;
  const AllEndangeredAnimalsByBreed({
    Key? key,
    required this.name,
    required this.image,
    required this.index,
...
class _ClassTypeInfoWidgetState extends State<ClassTypeInfoWidget> {
  final GetAllEndangerdAnimals animal = GetAllEndangerdAnimals();
